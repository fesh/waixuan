				...
				success:function(data){					
					if(!data){
						...
						$.each(data.data,function(index, item){
							...
							$(options.target).append('<li class="comment-item comment-item-'+item.id+' clearfix"><div class="comment-item-main"><div class="comment-item-bar"><span class="comment-item-author"><a href="#">'+item.username+'</a></span><span class="comment-item-pubdate">'+item.pub_time+'</span></div><div class="comment-item-content">'+item.content+'</div><!--<div class="comment-item-action"><a class="comment-item-digg" onclick="comment.digg(1236, 0);return false;" href="#">支持<span class="digg-num">(0)</span><span class="comment-item-increase">+1</span></a><a class="comment-item-reply" onclick="comment.reply(1236);return false;" href="#">回复</a><a href="#" class="comment-item-share" onclick="comment.share(1236);return false;">分享</a></div>--></div></li>');
						});
					}
